...
if (isset($_SESSION['email'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p>Di bawah ini adalah hasil dari Quiz yang sudah kamu kerjakan.</p>";
        ...
        echo '<div id="content" class="p-4 p-md-5 pt-5">';
        echo "<h2 class='mb-4'>Selamat Datang $user!</h2>";
        echo "<p>Anda belum pernah mengerjakan Quiz. Silahkan Kerjakan Quiz!</p>";
        echo '</div>';
        echo '</div>';
        echo '<script src="js/jquery.min.js"></script>';
        echo '<script src="js/popper.js"></script>';
...
<html lang='en'>
  <head>
	...
	<title>3DCurvedSide-Login</title>
