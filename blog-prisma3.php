...
?>
	<div class="container">
        ...
        <strong>Luas Permukaan prisma</strong>
        <div class="ml-5">
            Lp = 2 × ((p×l) + (p×t) + (l×t))
        </div>
        <strong>Volume Prisma</strong>
        <div class="ml-5">
            V = Luas alas x tinggi
        </div>
        Catatan : rumus menentukan luas permukaan dan volume prisma disesuaikan dengan bentuk alas prisma
        <div class="text-center">
            <table class="mx-auto mb-5">
                ...
                <tr>
                    <td>
                        <a href="blog-prisma1.php">1</a>
                    </td>
                    <td>
                        <a href="blog-prisma2.php">2</a>
                    </td>
                    <td>
                        <a href="blog-prisma3.php">3</a>
                    </td>
                </tr>
            </table>
